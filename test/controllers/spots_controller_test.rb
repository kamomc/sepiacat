...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { comment: @spot.comment, image: @spot.image, latitude: @spot.latitude, longitude: @spot.longitude, name: @spot.name, year: @spot.year } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { comment: @spot.comment, image: @spot.image, latitude: @spot.latitude, longitude: @spot.longitude, name: @spot.name, year: @spot.year } }
